...
/** \file
    ...
    - Use Timer4 instead of Timer1 on Mega: USE_TIMER4 (default 0)
...
/** Use Timer4 instead of Timer1 when using Mega in case there are timer
    conflicts.
    XLAT: Mega pin 11 -> Mega Pin 6
    BLANK: Mega pin 12 -> Mega Pin 7 */
#define USE_TIMER4    1
...
/*  You can change the VPR and XERR pins freely.  The defaults are defined in
